 ...
 */
package br.ufmt.genericsebalgpu.landsat;



import br.ufmt.genericsebalgpu.exceptions.TiffErrorBandsException;
import br.ufmt.genericsebalgpu.exceptions.TiffNotFoundException;
import br.ufmt.genericsebalgpu.exceptions.CalibrationException;
import br.ufmt.genericsebalgpu.sebal.Sebal;
import br.ufmt.genericsebalgpu.utils.Constants;
import br.ufmt.genericsebalgpu.utils.DataFile;
...
////                        System.out.println("mSaviMin:" + mSaviMin);
                        ...
                        Sebal.calculaAB(coef, RnHot, GHot, Uref, SAVI_hot, tMax, tMin);
